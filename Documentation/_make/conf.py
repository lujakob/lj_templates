# -*- coding: utf-8 -*-
#
# Lj Templates documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 26 Apr 2016 10:43:43 +0200.
#
...
project = u'Lj Templates'
copyright = u'2016, Lukas Jakob'
...
htmlhelp_basename = 'lj_templatesdoc'
...
latex_documents = [
    ('Index', 'lj_templates.tex', u'Lj Templates',
     u'Lukas Jakob', 'manual'),
]
...
pdf_documents = [
    ('Index', 'lj_templates', u'Lj Templates',
     u'Lukas Jakob'),
]
...
texinfo_documents = [
    ('Index', 'lj_templates', u'Lj Templates',
     u'Lukas Jakob', 'Lj Templates', 'One line description of project.',
     'Miscellaneous'),
]
